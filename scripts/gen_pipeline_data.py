...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_file1', '-o1', type=str, required=True, help='Json file for the DrQA models')
    parser.add_argument('--output_file2', '-o2', type=str, required=True, help='Files for the seq2seq models')
